...
import view.sub.JDEditURL;
import view.sub.JDCreateURL;
import view.sub.JDBackupPlan;
import com.controller.XMLController;
import com.helper.file.FileHelper;
import com.helper.file.FileObjDic;
...
import view.property.JDInit;
import view.property.JDRemote;
...
public class JFManagement extends javax.swing.JFrame {
    ...
    private void jmiNewlinkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiNewlinkActionPerformed
        if(jdcurl==null){
            jdcurl=new JDCreateURL(this,true,"新建连接");
        }else{
            jdcurl.setValue("新建连接");
        }
    ...
    private void addComponents() {
        ...
        /*
        jmiAddLink.addActionListener((ActionEvent evt) ->{
            jmiAddLinkActionPerformed(evt);
        });*/
        jmiDelLink = new JMenuItem("删除连接");
        jmiDelLink.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent evt){
        ...
        jmiEditLink.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent evt){
        ...
        jmiNewBackup.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent evt){
    ...
    private void jmiEditLinkActionPerformed(java.awt.event.ActionEvent evt){
        ...
        if (node == null)
            return;
        if(jdeurl==null){
            jdeurl=new JDEditURL(this,true,"修改连接",node.getUserObject().toString());
        }else{
            jdeurl.setvalue("修改连接", node.getUserObject().toString());
        }
