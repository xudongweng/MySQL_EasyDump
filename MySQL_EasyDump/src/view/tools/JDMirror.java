...
public class JDMirror extends javax.swing.JDialog implements Runnable{
    ...
    private void jbSynchroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSynchroActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, sqle.toString(), "错误", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private boolean posCompare(MySQLObj msoA,MySQLObj msoB){
        ...
        try{
            ...
            this.jtaCompareInfo.insert(sqle.toString(),this.jtaCompareInfo.getText().length());
            this.jtaCompareInfo.setCaretPosition(this.jtaCompareInfo.getText().length());//设置自动最底部
            return false;
        }catch(Exception e){
