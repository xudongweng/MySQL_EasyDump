 ...
 * @author xudong.weng
 */
public class JDRemotes extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public JDRemotes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
